    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS:
            ...
            if user.role == 'MEDECIN':
                return obj.medecin and obj.medecin.user_id == user.id
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS:
            if user.role == 'ADMIN':
                return True
            if user.role == 'PATIENT':
                return obj.rdv.patient.user_id == user.id
            if user.role == 'MEDECIN':
                return obj.medecin.user_id == user.id
            return False
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS:
            if user.role == 'ADMIN':
                return True
            if user.role == 'PATIENT':
                return obj.consultation.rdv.patient.user_id == user.id
            if user.role == 'MEDECIN':
                return obj.consultation.medecin.user_id == user.id
            return False
    ...
    def has_object_permission(self, request, view, obj):
        ...
        if request.method in permissions.SAFE_METHODS:
            if user.role == 'ADMIN':
                return True
            if user.role == 'PATIENT':
                return obj.ordonnance.consultation.rdv.patient.user_id == user.id
            if user.role == 'MEDECIN':
                return obj.ordonnance.consultation.medecin.user_id == user.id
            return False
